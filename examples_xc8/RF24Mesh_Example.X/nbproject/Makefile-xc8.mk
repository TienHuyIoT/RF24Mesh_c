...
SOURCEFILES_QUOTED_IF_SPACED=RF24Mesh_Example.c pic_main.c serial.c ../../../RF24_c/utility/XC8/spi.c umalloc.c ../../../RF24_c/RF24.c ../../../RF24Network_c/RF24Network.c ../../RF24Mesh.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/RF24Mesh_Example.p1 ${OBJECTDIR}/pic_main.p1 ${OBJECTDIR}/serial.p1 ${OBJECTDIR}/_ext/2031907356/spi.p1 ${OBJECTDIR}/umalloc.p1 ${OBJECTDIR}/_ext/381377385/RF24.p1 ${OBJECTDIR}/_ext/1478480717/RF24Network.p1 ${OBJECTDIR}/_ext/43898991/RF24Mesh.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/RF24Mesh_Example.p1.d ${OBJECTDIR}/pic_main.p1.d ${OBJECTDIR}/serial.p1.d ${OBJECTDIR}/_ext/2031907356/spi.p1.d ${OBJECTDIR}/umalloc.p1.d ${OBJECTDIR}/_ext/381377385/RF24.p1.d ${OBJECTDIR}/_ext/1478480717/RF24Network.p1.d ${OBJECTDIR}/_ext/43898991/RF24Mesh.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/RF24Mesh_Example.p1 ${OBJECTDIR}/pic_main.p1 ${OBJECTDIR}/serial.p1 ${OBJECTDIR}/_ext/2031907356/spi.p1 ${OBJECTDIR}/umalloc.p1 ${OBJECTDIR}/_ext/381377385/RF24.p1 ${OBJECTDIR}/_ext/1478480717/RF24Network.p1 ${OBJECTDIR}/_ext/43898991/RF24Mesh.p1

# Source Files
SOURCEFILES=RF24Mesh_Example.c pic_main.c serial.c ../../../RF24_c/utility/XC8/spi.c umalloc.c ../../../RF24_c/RF24.c ../../../RF24Network_c/RF24Network.c ../../RF24Mesh.c
...
${OBJECTDIR}/_ext/43898991/RF24Mesh.p1: ../../RF24Mesh.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/43898991" 
	@${RM} ${OBJECTDIR}/_ext/43898991/RF24Mesh.p1.d 
	@${RM} ${OBJECTDIR}/_ext/43898991/RF24Mesh.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=none  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 -I"../../" -I"../../../RF24Network_c" -I"../../../RF24_c" -I"../../../RF24_c/utility/XC8" --warn=-3 --asmlist -DXPRJ_xc8=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=hybrid:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/43898991/RF24Mesh.p1  ../../RF24Mesh.c 
	@-${MV} ${OBJECTDIR}/_ext/43898991/RF24Mesh.d ${OBJECTDIR}/_ext/43898991/RF24Mesh.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/43898991/RF24Mesh.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
